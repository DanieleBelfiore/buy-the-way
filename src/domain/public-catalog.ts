...
export const PUBLIC_CATALOG: ReadonlyArray<PublicCatalogEntry> = [
  ...
  // meat_fish
  { slug: 'pollo', name_it: 'Pollo', name_en: 'Chicken', category: 'meat_fish', icon: '🍗' },
  { slug: 'petto-pollo', name_it: 'Petto di pollo', name_en: 'Chicken breast', category: 'meat_fish', icon: '🍗' },
  { slug: 'manzo', name_it: 'Manzo', name_en: 'Beef', category: 'meat_fish', icon: '🥩' },
  { slug: 'macinato', name_it: 'Carne macinata', name_en: 'Ground beef', category: 'meat_fish', icon: '🥩' },
  { slug: 'maiale', name_it: 'Maiale', name_en: 'Pork', category: 'meat_fish', icon: '🥩' },
  { slug: 'salsiccia', name_it: 'Salsiccia', name_en: 'Sausage', category: 'meat_fish', icon: '🌭' },
  { slug: 'prosciutto-cotto', name_it: 'Prosciutto cotto', name_en: 'Cooked ham', category: 'meat_fish', icon: '🥓' },
  { slug: 'prosciutto-crudo', name_it: 'Prosciutto crudo', name_en: 'Prosciutto', category: 'meat_fish', icon: '🥓' },
  { slug: 'bresaola', name_it: 'Bresaola', name_en: 'Bresaola', category: 'meat_fish', icon: '🥩' },
  { slug: 'salame', name_it: 'Salame', name_en: 'Salami', category: 'meat_fish', icon: '🥓' },
  { slug: 'mortadella', name_it: 'Mortadella', name_en: 'Mortadella', category: 'meat_fish', icon: '🥓' },
  { slug: 'speck', name_it: 'Speck', name_en: 'Speck', category: 'meat_fish', icon: '🥓' },
  { slug: 'tonno', name_it: 'Tonno', name_en: 'Tuna', category: 'meat_fish', icon: '🐟' },
  { slug: 'salmone', name_it: 'Salmone', name_en: 'Salmon', category: 'meat_fish', icon: '🐟' },
  { slug: 'merluzzo', name_it: 'Merluzzo', name_en: 'Cod', category: 'meat_fish', icon: '🐟' },
  { slug: 'gamberi', name_it: 'Gamberi', name_en: 'Shrimp', category: 'meat_fish', icon: '🦐' },
  { slug: 'vongole', name_it: 'Vongole', name_en: 'Clams', category: 'meat_fish', icon: '🦪' },
  { slug: 'cozze', name_it: 'Cozze', name_en: 'Mussels', category: 'meat_fish', icon: '🦪' },
  { slug: 'orata', name_it: 'Orata', name_en: 'Sea bream', category: 'meat_fish', icon: '🐟' },
  { slug: 'branzino', name_it: 'Branzino', name_en: 'Sea bass', category: 'meat_fish', icon: '🐟' },
  ...
  // other
  { slug: 'tonno-scatola', name_it: 'Tonno in scatola', name_en: 'Canned tuna', category: 'other', icon: '🥫' },
  { slug: 'pelati', name_it: 'Pomodori pelati', name_en: 'Peeled tomatoes', category: 'other', icon: '🥫' },
  { slug: 'passata', name_it: 'Passata di pomodoro', name_en: 'Tomato passata', category: 'other', icon: '🥫' },
  { slug: 'mais-scatola', name_it: 'Mais in scatola', name_en: 'Canned corn', category: 'other', icon: '🥫' },
  { slug: 'fagioli', name_it: 'Fagioli', name_en: 'Beans', category: 'other', icon: '🫘' },
  { slug: 'ceci', name_it: 'Ceci', name_en: 'Chickpeas', category: 'other', icon: '🫘' },
  { slug: 'lenticchie', name_it: 'Lenticchie', name_en: 'Lentils', category: 'other', icon: '🫘' },
  { slug: 'piselli-scatola', name_it: 'Piselli in scatola', name_en: 'Canned peas', category: 'other', icon: '🥫' },
  { slug: 'olive', name_it: 'Olive', name_en: 'Olives', category: 'other', icon: '🫒' },
  { slug: 'capperi', name_it: 'Capperi', name_en: 'Capers', category: 'other', icon: '🌿' },
  { slug: 'pesto', name_it: 'Pesto', name_en: 'Pesto', category: 'other', icon: '🌿' },
  { slug: 'sugo-pronto', name_it: 'Sugo pronto', name_en: 'Pasta sauce', category: 'other', icon: '🥫' },
  { slug: 'maionese', name_it: 'Maionese', name_en: 'Mayonnaise', category: 'other', icon: '🥚' },
  { slug: 'ketchup', name_it: 'Ketchup', name_en: 'Ketchup', category: 'other', icon: '🍅' },
  { slug: 'senape', name_it: 'Senape', name_en: 'Mustard', category: 'other', icon: '🌭' },
  { slug: 'pepe', name_it: 'Pepe', name_en: 'Pepper', category: 'other', icon: '🌶️' },
  { slug: 'origano', name_it: 'Origano', name_en: 'Oregano', category: 'other', icon: '🌿' },
  { slug: 'peperoncino', name_it: 'Peperoncino', name_en: 'Chili pepper', category: 'other', icon: '🌶️' },
  { slug: 'mandorle', name_it: 'Mandorle', name_en: 'Almonds', category: 'other', icon: '🌰' },
  { slug: 'noci', name_it: 'Noci', name_en: 'Walnuts', category: 'other', icon: '🌰' },
  { slug: 'nocciole', name_it: 'Nocciole', name_en: 'Hazelnuts', category: 'other', icon: '🌰' },
  { slug: 'pinoli', name_it: 'Pinoli', name_en: 'Pine nuts', category: 'other', icon: '🌰' },
