...
- **Items:** Dual catalog autocomplete, favorites algorithm (recency-weighted, min uses, cap 30), categories, photos, voice, bulk paste, undo delete, push notifications.
